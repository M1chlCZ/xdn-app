...
class StealthTxView extends StatelessWidget {
  ...
  const StealthTxView({Key? key, this.transaction, this.customLocale}) : super(key: key);
    ...
    return Opacity(
      ...
      child: Card(
          ...
          child: InkWell(
            ...
            onTap: () {
              Dialogs.openTransactionStealthBox(context, transaction!);
            },
            child: Container(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                width: 125,
                                child: AutoSizeText(
                                  transaction!.category == "receive" ? "+ ${Utils.formatAmount(transaction!.amount!.toString())} XDN" : "- ${transaction!.amount!.toString().replaceFirst('-', '')} XDN",
