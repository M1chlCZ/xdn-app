...
class SecureStorage {
  ...
  static Future<String?> read({required String key}) {
    try {
      ...
      return  mstorage.read(key: key, iOptions: optionsApple, aOptions: optionsAndroid, webOptions: webOptions);
    } catch (e) {
      print(e);
  ...
  static Future<void> write({required String key,required String value}) {
    try {
      ...
      const optionsAndroid = AndroidOptions(encryptedSharedPreferences: true);
      const webOptions = WebOptions(dbName: "CNliCGCAgu", publicKey: "6i81ge6Fc3bqgxbtc1Wl");
      return  mstorage.write(key: key, value: value, iOptions: optionsApple, aOptions: optionsAndroid, webOptions: webOptions);
    } catch (e) {
      print(e);
      return Future.value(null);
    }
  ...
  static Future<void> deleteStorage({required String key}) {
    try {
      ...
      const optionsAndroid = AndroidOptions(encryptedSharedPreferences: true);
      const webOptions = WebOptions(dbName: "CNliCGCAgu", publicKey: "6i81ge6Fc3bqgxbtc1Wl");
      return   mstorage.delete(key: key, iOptions: optionsApple, aOptions: optionsAndroid, webOptions: webOptions);
    } catch (e) {
      print(e);
      return Future.value(null);
    }
  ...
  static Future<void> deleteAllStorage() {
    try {
      ...
      const optionsAndroid = AndroidOptions(encryptedSharedPreferences: true);
      const webOptions = WebOptions(dbName: "CNliCGCAgu", publicKey: "6i81ge6Fc3bqgxbtc1Wl");
      return   mstorage.deleteAll(iOptions: optionsApple, aOptions: optionsAndroid, webOptions: webOptions);
    } catch (e) {
      print(e);
      return Future.value(null);
    }
