...
class BalanceStealthCardMenu extends ConsumerStatefulWidget {
  ...
  const BalanceStealthCardMenu({super.key, required this.goto});
          ...
          child: Stack(
            children: [
                    ...
                    return Padding(
                        ...
                        child: AutoSizeText("Unknown",
                            ...
                            style: Theme.of(context)
                                .textTheme
                                .headlineSmall!
                                .copyWith(fontWeight: FontWeight.w200, fontSize: 28.0)));
                  }
                  StealthBalance m = data;
                  var balance = 0.0;
                  var immature = 0.0;
                  if (m.balances!.isNotEmpty) {
                    for (var element in m.balances!) {
                      balance += double.parse(element.spendable.toString());
                      immature += double.parse(element.immature.toString());
                    }
                  }
                  var textImature = immature.toInt() == 0
                      ? ''
                      : "${AppLocalizations.of(context)!.immature}: ${Utils.formatBalance(immature)} XDN";
                  if (textImature != '') {
                    textImature = '';
                  }
                              ...
                              Container(
                                  ...
                                  child: Center(
                                    ...
                                    style: Theme.of(context)
                                        .textTheme
                                        .headlineSmall!
                                        .copyWith(color: Colors.white70, fontSize: 24.0, fontWeight: FontWeight.w800),
                                  ))),
                            ],
                          ),
                        ),
                            ...
                            ? SizedBox(
                                ...
                                child: AutoSizeText(textImature,
                                    ...
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyLarge!
                                        .copyWith(fontSize: 14.0, color: Colors.white54)),
                              )
                            : Container(),
                      ],
                    ),
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: const DecorationImage(
                                image: AssetImage("images/test_pattern.png"), fit: BoxFit.cover, opacity: 1.0),
                          ),
                          child: Text(
                            'Connect your BSC wallet in Voting section'.capitalize(),
                            style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                                fontSize: 14.0, color: Colors.white.withOpacity(0.6), fontWeight: FontWeight.w800),
                          )));
                }, loading: () {
                  return const Center(
                    child: Column(
              ...
              Padding(
                ...
                child: SizedBox(width: 75, child: Image.asset("images/stealth.png")),
              )
            ],
          ),
        ),
