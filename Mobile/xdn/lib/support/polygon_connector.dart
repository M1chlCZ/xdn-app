...
class WalletConnectPolygonCredentials extends CustomTransactionSender {
  WalletConnectPolygonCredentials({required this.provider});
...
class PolygonConnector implements WalletConnector {
  PolygonConnector() {
    _connector = WalletConnectQrCodeModal(
      connector: WalletConnect(
        bridge: 'https://2FSqhy6MWb67bGoEx1jwv4eANrz:04f9238a26a58572ea9e30ab6aa58485@eth2-beacon-mainnet.infura.io',
  ...
  Future<SessionStatus?> connect(BuildContext context) async {
    return await _connector.connect(context);
  }
  ...
  Future<String?> sendTestingAmount({
    ...
    final credentials = WalletConnectPolygonCredentials(provider: _provider);
  ...
  String get address =>  '0x310052769DE50103600981A02bba373f0e812a0d';
  ...
  final _ethereum = Web3Client(
      'https://polygon-mumbai.infura.io/v3/2FSqhy6MWb67bGoEx1jwv4eANrz',
      Client());
}