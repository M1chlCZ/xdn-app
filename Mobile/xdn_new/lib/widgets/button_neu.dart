...
class NeuButton extends StatelessWidget {
  ...
  const NeuButton({super.key, this.color, this.onTap, this.icon, this.imageIcon, this.splashColor, this.animIcon, this.radius = 4.0, this.child, this.height, this.width});
  ...
  Widget build(BuildContext context) {
    return _getContainer(
      ...
      child: ClipRRect(
        ...
        child: Material(
          color: color ?? Theme.of(context).canvasColor, // labelLarge color
          child: InkWell(
